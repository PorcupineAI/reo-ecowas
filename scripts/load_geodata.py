...
def seed_sites():
    ...
    try:
        ...
        # Sample sites across ECOWAS
        sample_sites = [
            {"name": "Ago-Are Health Center", "country": "Nigeria", "lat": 8.5, "lon": 4.2, "pop": 5000, "type": "health"},
            {"name": "Kandi Agro-Processing", "country": "Benin", "lat": 10.5, "lon": 1.8, "pop": 12000, "type": "agro_processing"},
            {"name": "Sokode Community Grid", "country": "Togo", "lat": 8.0, "lon": 1.2, "pop": 8000, "type": "education"},
            {"name": "Wa Solar Mini-Grid", "country": "Ghana", "lat": 10.0, "lon": -2.5, "pop": 15000, "type": "commercial"},
            {"name": "Bouake Rice Mill", "country": "Côte d'Ivoire", "lat": 7.7, "lon": -5.0, "pop": 2000, "type": "agro_processing"},
        ]
        ...
        for s in sample_sites:
            ...
            site_data = {
                ...
                "population_density": site.population / 10,
                "productive_use_type": site.productive_use_type,
                "road_distance_km": random.uniform(1, 10)
            }
        ...
        # Seed Regulatory Scores for ECOWAS 15
        countries = [
        ...
        for c in countries:
            ...
            friction = (5 - reg.tariff_approval_time_score) + (5 - reg.import_duty_on_solar_score) + \
                       (5 - reg.local_content_requirement_score) + (5 - reg.land_acquisition_score) + \
